...
[![Coverage Status](https://coveralls.io/repos/github/cliffano/jazz-cli/badge.svg?branch=main)](https://coveralls.io/r/cliffano/jazz-cli?branch=main)
...
Jazz CLI is a command-line interface for [Jazz](https://github.com/cliffano/jazz) templating engine.
